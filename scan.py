...
def main():
    ...
    print("                       Version 1.0.0                    ")
    print("                   A project by Vladyslav K.               ")
    print("-" * 60)
    time.sleep(1)
    ...
    print("-" * 60)
    print("Recommends the following network scan:")
    print("*" * 60)
    print("nmap -p{ports} -sV {ip}".format(ports=",".join(discovered_ports), ip=target))
    print("*" * 60)
    nmap = "nmap -p{ports} -sV {ip}".format(ports=",".join(discovered_ports), ip=target)
    t3 = datetime.now()
    total1 = t3 - t1
